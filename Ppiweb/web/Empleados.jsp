    ...
    <body>
        <div id="Contenido">
            ...
            <div id="Empleado">
                ...
                Departamento: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select class="form-control" id="TipoDocumento" name="Asunto">
                                                            <option value> Seleccione</option>
                                                            <option value> Nit</option>
                                                            <option value> CC</option>
                                                            <option value> Cedula extranjera</option>
                                                         </select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Municipio: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select class="form-control" id="TipoDocumento" name="Asunto">
                                                            <option value> Seleccione</option>
                                                            <option value> Nit</option>
                                                            <option value> CC</option>
                                                            <option value> Cedula extranjera</option>
                                                         ...
                                                         <br><br>
                Cargo: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select class="form-control" id="TipoDocumento" name="Asunto">
                                                            <option value> Seleccione</option>
                                                         ...
                                                         <br>
                Referencias Laborales:  <textarea class="form-control" name="Mensaje" id="MensajeTexarea"> </textarea>
                Referencias Personales: <textarea class="form-control" name="Mensaje" id="MensajeTexarea"> </textarea> <br>
